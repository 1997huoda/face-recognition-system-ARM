...
void global_init(){
	...
	//*******************lbf_cascador init**********************/
	const char *model_name = "./my_helen.model";//lfpw	helen	
...
void face_alignment(Mat image_roi){	
		...
		double* P_36 =shape.ptr<double>(36);//左眼外角
        double* P_39 =shape.ptr<double>(39);
        double* P_27 =shape.ptr<double>(27);
        double* P_42 =shape.ptr<double>(42);
		double* P_45 =shape.ptr<double>(45);//右眼外角
        double* P_28 =shape.ptr<double>(28);
        double* P_29 =shape.ptr<double>(29);
		double* P_30 =shape.ptr<double>(30);//鼻尖
        double* P_31 =shape.ptr<double>(31);//鼻zuo
        double* P_35 =shape.ptr<double>(35);//鼻you
        double* P_48 =shape.ptr<double>(48);//嘴左角
        double* P_54 =shape.ptr<double>(54);//嘴右角
        
//         cout<<" left eye="<<P_36[0]<<","<<P_36[1]<<"    right eye="<<P_45[0]<<","<<P_45[1]<<"    nose="<<P_30[0]<<","<<P_30[1]<<"    left nose="<<P_31[0]<<","<<P_31[1]<<"   right  nose="<<P_35[0]<<","<<P_35[1]<<"    left mouth="<<P_48[0]<<","<<P_48[1]<<"    right mouth="<<P_54[0]<<","<<P_54[1]<<endl;
        
        Point2f a36(P_36[0],P_36[1]);
        Point2f a39(P_39[0],P_39[1]);
        Point2f a27(P_27[0],P_27[1]);
        Point2f a42(P_36[0],P_42[1]);
        Point2f a45(P_45[0],P_45[1]);
        Point2f a28(P_28[0],P_28[1]);
        Point2f a29(P_29[0],P_29[1]);        
        Point2f a30(P_30[0],P_30[1]);
        Point2f a31(P_31[0],P_31[1]);
        Point2f a35(P_35[0],P_35[1]);
        
        Point2f a48(P_48[0],P_48[1]);
        Point2f a54(P_54[0],P_54[1]);
        
//         Point2f p36(0.2559*size_box.width ,0.2012*size_box.height);
//         Point2f p39(0.3885*size_box.width ,0.1972*size_box.height);
//         Point2f p27(0.5167*size_box.width ,0.1798*size_box.height);
//         Point2f p42(0.6331*size_box.width ,0.19184*size_box.height);
//         Point2f p45(0.7613*size_box.width ,0.20055*size_box.height);
//         Point2f p28(0.5199*size_box.width ,0.248*size_box.height);
//         Point2f p29(0.522*size_box.width ,0.3161765*size_box.height);
//         Point2f p30(0.52425*size_box.width ,0.383*size_box.height);
//         Point2f p31(0.4488*size_box.width ,0.4552*size_box.height);
//         Point2f p35(0.59752*size_box.width ,0.4499*size_box.height);
        
        Point2f p36(20,41);//20
        Point2f p45(72,41);
//         Point2f nose_e(50,58);
//         Point2f left_n(27,77);
//         Point2f right_n(27,77);
        Point2f p48(30,77);//30
        Point2f p54(63,77);


        //仿射变换
//         Point2f src[]={left_eye,right_eye,nose,left_mouth,right_mouth};
//         Point2f dst[]={left_e,right_e,nose_e,left_m,right_m};
//         Mat M=getAffineTransform(src,dst);
//         warpAffine(image_roi, image_roi, M,size_box,0,0,INTER_LINEAR);
        
        //仿射变换
        vector<Point2f> src={a36,/*a27,*/a45,/*a31,a35*/a48,a54};
        vector<Point2f>dst={p36,/*p27,*/p45,/*p31,p35*/p48,p54 }; 
/*        vector<Point2f> src={a36,a39,a27,a42,a45,a28,a29,a30,a31,a35};
        vector<Point2f>dst={p36,p39,p27,p42,p45,p28,p29,p30,p31,p35 };*/  
//         vector<Point2f> src,dst;      
//         src.push_back(a36);src.push_back(a39);src.push_back(a27);src.push_back(a42);src.push_back(a45);
//         dst.push_back(p36);dst.push_back(p39);dst.push_back(p27);dst.push_back(p42);dst.push_back(p45);
        Mat M=estimateRigidTransform(src,dst,false);
        warpAffine(image_roi, image_roi, M,size_box,0,0,INTER_LINEAR);
        
        //透射变换
//         Mat M=getPerspectiveTransform(src,dst);
//         warpPerspective(image_roi, image_roi, M,size_box);
